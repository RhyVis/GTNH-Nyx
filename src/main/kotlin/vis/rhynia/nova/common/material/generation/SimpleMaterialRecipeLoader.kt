...
import vis.rhynia.nova.api.enums.NovaValues.RecipeValues.TICK
import vis.rhynia.nova.common.recipe.RecipePool

class SimpleMaterialRecipeLoader(private val mat: SimpleMaterial) : RecipePool() {
  ...
  private fun loadCellRecipes() {
    ...
    SimpleMaterialLoader.fluidMap[mat]?.forEach { (state, fluid) ->
