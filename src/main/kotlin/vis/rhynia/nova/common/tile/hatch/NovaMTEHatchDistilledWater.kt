...
class NovaMTEHatchDistilledWater : NovaMTEHatchFluidGenerator {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): MetaTileEntity {
    return NovaMTEHatchDistilledWater(
  ...
  override fun getFluidToGenerate(): Fluid? {
    return FluidUtils.getFluidStack("ic2distilledwater", 1).getFluid()
  }
