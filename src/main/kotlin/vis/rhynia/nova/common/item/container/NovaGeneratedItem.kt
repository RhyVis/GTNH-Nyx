...
import vis.rhynia.nova.common.material.generation.SimpleMaterialLoader.materialMap
import vis.rhynia.nova.common.material.generation.SimpleMaterialLoader.materialSet

class NovaGeneratedItem(val orePrefix: OrePrefixes) :
    MetaGeneratedItem("NovaGeneratedMetaItem${orePrefix.name}", 32766, 0) {
  init {
  ...
  override fun getItemStackDisplayName(stack: ItemStack): String? {
    val material = materialMap[stack.itemDamage.toShort()] ?: NovaMaterials.Null
