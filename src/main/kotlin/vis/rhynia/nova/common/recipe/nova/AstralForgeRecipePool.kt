...
class AstralForgeRecipePool : RecipePool() {
  ...
  override fun loadRecipes() {
        ...
        .forEach { s ->
          val inputArray =
              arrayOfNulls<ItemStack>(16).apply {
                ...
                this[1] = NovaItemList.LensAstriumInfinity.get(0)
                fill(s.getDust(64), 2)
              }
          builder()
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NovaItemList.LensAstriumInfinity.get(0), *Array(14) { na2So4 })
        .itemOutputs(
            *Array(10) { naDust },
            Materials.Sulfur.getDust(64),
            Materials.Sulfur.getDust(64),
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NovaItemList.LensAstriumInfinity.get(0), *Array(4) { smMix })
        .itemOutputs(
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NovaItemList.LensAstriumInfinity.get(0), *Array(4) { ceMix })
        .itemOutputs(
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NovaItemList.LensAstriumInfinity.get(0), *Array(8) { irRe })
        .itemOutputs(
            *Array(8) { irDust },
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NovaItemList.LensAstriumInfinity.get(0), *Array(8) { osRe })
        .itemOutputs(
            Materials.Iridium.getDust(64),
            Materials.Iridium.getDust(64),
            Materials.Iridium.getDust(64),
