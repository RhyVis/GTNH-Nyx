...
object NyxRecipeMaps {
  ...
  val astralForgeRecipes: RecipeMap<RecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.astralForge")
          .maxIO(16, 16, 8, 8)
          .minInputs(1, 0)
  ...
  val thermonuclearControlRecipes: RecipeMap<RecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.thermonuclearControl")
          .maxIO(4, 0, 2, 4)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .logoSize(17, 17)
  ...
  val transcendentReactorRecipes: RecipeMap<NyxRecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.transcendentReactor", ::NyxRecipeMapBackend)
          .maxIO(16, 6, 8, 6)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .logoSize(17, 17)
  ...
  val integratedAssemblyRecipes: RecipeMap<NyxRecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.integratedAssembly", ::NyxRecipeMapBackend)
          .maxIO(12, 1, 8, 0)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .logoSize(17, 17)
  ...
  val microAssemblyRecipes: RecipeMap<NyxRecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.microAssembly", ::NyxRecipeMapBackend)
          .maxIO(8, 1, 8, 0)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .logoSize(17, 17)
  ...
  val superconductingFormingRecipes: RecipeMap<NyxRecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.superconductingForming", ::NyxRecipeMapBackend)
          .maxIO(6, 2, 3, 2)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .disableOptimize()
  ...
  val quarkRefactoringRecipes: RecipeMap<NyxRecipeMapBackend> =
      RecipeMapBuilder.of("nyx.recipe.quarkRefactoring", ::NyxRecipeMapBackend)
          .maxIO(6, 2, 3, 2)
          .minInputs(1, 0)
          .logo(NyxValues.TextureSets.Logo32)
          .disableOptimize()
