...
class AstralForgeRecipeFrontend(
    ...
    override fun getItemInputPositions(itemInputCount: Int): List<Pos2d> =
        UIHelper.getGridPositions(itemInputCount, X_ORIGIN_L, Y_ORIGIN, X_DIRECTION_MAX)

    override fun getItemOutputPositions(itemOutputCount: Int): List<Pos2d> =
        UIHelper.getGridPositions(itemOutputCount, X_ORIGIN_R, Y_ORIGIN, X_DIRECTION_MAX)

    override fun getFluidInputPositions(fluidInputCount: Int): List<Pos2d> =
        UIHelper.getGridPositions(
            fluidInputCount,
            X_ORIGIN_L,
            Y_ORIGIN + 4 * ROW_WIDTH,
            X_DIRECTION_MAX,
        )
