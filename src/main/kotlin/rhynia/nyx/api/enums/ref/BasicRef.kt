...
object BasicRef {
    ...
    fun getQuantumAnomaly(amount: Int): ItemStack = GTModHandler.getModItem(GTPlusPlus.ID, "MU-metaitem.01", amount.toLong(), 32105)

    fun getFusionMatrixCatalyst(): ItemStack = GTModHandler.getModItem(GTPlusPlus.ID, "MU-metaitem.01", 0, 32100)
}
