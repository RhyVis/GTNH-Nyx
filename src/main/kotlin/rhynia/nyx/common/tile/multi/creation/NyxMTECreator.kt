...
class NyxMTECreator : NyxMTECubeBase<NyxMTECreator> {
    ...
    override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity = NyxMTECreator(this.mName)
    ...
    override fun getInfoDataExtra(): Array<String> = arrayOf("${AQUA}复制目标: ${GOLD}$pProcessDisplayName")
