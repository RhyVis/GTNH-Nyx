...
class NyxMTEKelvinTransformField : NyxMTECubeBase<NyxMTEKelvinTransformField> {
    ...
    override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity = NyxMTEKelvinTransformField(mName)
    ...
    override val rDurationModifier: Double
        get() =
            if (pRecipeMode.index == 0) {
                0.95.pow(GTUtility.getTier(this.maxInputVoltage).toDouble())
            } else {
                1.0
            }
