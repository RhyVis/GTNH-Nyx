...
class NyxMTEAtomMacro : NyxMTEBase<NyxMTEAtomMacro> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return NyxMTEAtomMacro(this.mName)
  }
  ...
  override fun onScrewdriverRightClick(
    ...
    if (baseMetaTileEntity.isServerSide) {
      ...
      GTUtility.sendChatToPlayer(
          aPlayer, StatCollector.translateToLocal("nyx.AtomMacro.pRecipeMode.${pRecipeMode.index}"))
    }
  }
  // endregion
  ...
  override fun genStructureDefinition(): IStructureDefinition<NyxMTEAtomMacro> =
      StructureDefinition.builder<NyxMTEAtomMacro>()
          ...
          .addElement(
              'G',
              HatchElementBuilder.builder<NyxMTEAtomMacro>()
