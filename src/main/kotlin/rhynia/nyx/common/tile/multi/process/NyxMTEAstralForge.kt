...
class NyxMTEAstralForge : NyxMTEBase<NyxMTEAstralForge> {
    ...
    override fun newMetaEntity(aTileEntity: IGregTechTileEntity): IMetaTileEntity = NyxMTEAstralForge(mName)
        ...
        StructureDefinition
            ...
            .addElement(
                ...
                if (Mods.Avaritia.isModLoaded) {
                    ofBlock(LudicrousBlocks.resource_block, 1)
                } else {
                    ofFrame(Materials.Infinity)
                },
    ...
    override fun getInfoDataExtra(): Array<String> = arrayOf("${EnumChatFormatting.AQUA}稳定立场: ${EnumChatFormatting.GOLD}$uStableField")
