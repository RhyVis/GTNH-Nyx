...
class NyxMTESelectedEnergyGenerator : NyxMTECubeBase<NyxMTESelectedEnergyGenerator> {
    ...
    override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity = NyxMTESelectedEnergyGenerator(this.mName)
    ...
    override fun checkProcessing(): CheckRecipeResult {
        ...
        pEnergy =
            BigInteger
                .valueOf(Int.Companion.MAX_VALUE.toLong())
                .multiply(pConstruct)
    ...
    override fun getInfoDataExtra(): Array<String> = arrayOf("${AQUA}等效能量: ${GTUtility.formatNumbers(pConstruct)}MAX EU/t")
