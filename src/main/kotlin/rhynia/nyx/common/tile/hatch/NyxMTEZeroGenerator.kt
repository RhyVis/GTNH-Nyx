...
import rhynia.nyx.api.enums.NyxValues.TextureSets.Logo32
...
class NyxMTEZeroGenerator : MTETieredMachineBlock, IAddUIWidgets, IAddGregtechLogo {
  ...
  constructor(
      ...
      arrayOf(
          ...
          "使用螺丝刀切换至无线模式",
          "直接注入能量到无线网络!",
          NyxValues.CommonStrings.AddByNyx)) {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): MetaTileEntity {
    return NyxMTEZeroGenerator(mName, mTier.toInt(), mDescriptionArray, mTextures)
  }
