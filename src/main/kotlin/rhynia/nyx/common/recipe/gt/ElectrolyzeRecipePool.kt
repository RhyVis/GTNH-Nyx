...
class ElectrolyzeRecipePool : RecipePool() {
  ...
  override fun loadRecipes() {
    ...
    builder()
        ...
        .itemOutputs(Materials.Iron.getDust(4), NyxMaterials.Astrium.getDust(1))
    ...
    builder()
        ...
        .itemOutputs(Materials.Lead.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Nickel.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Zinc.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Copper.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Cobalt.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Antimony.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
    ...
    builder()
        ...
        .itemOutputs(Materials.Arsenic.getDust(4), NyxMaterials.Astrium.getDust(1))
        .outputChances(10000, 5000)
        .eut(NyxValues.RecipeValues.RECIPE_LV)
        .durSec(8)
        .addTo(ec)
