...
class TranscendentReactorRecipePool : RecipePool() {
    private val tr = NyxRecipeMaps.transcendentReactorRecipes
    ...
    private fun loadCatalyst() {
        ...
        altBuilder(tr) {
            itemInputs(
                ...
                NyxMaterials.AstralCatalystBaseExcited.getLiquid(catalystACA / 4),
                Materials.Helium.getGas(ingotModifier),
            ).fluidOutputs(
                MaterialsUEVplus.ExcitedDTCC.getFluid((recipeModifier * outputModifier).toLong()),
                NyxMaterials.AstralResidue.getLiquid(catalystACA / 8),
        ...
        altBuilder(tr) {
            itemInputs(
                ...
                NyxMaterials.AstralCatalystBaseExcited.getLiquid(catalystACA / 2),
                Materials.Helium.getGas(ingotModifier),
                Materials.Radon.getGas(ingotModifier),
            ).fluidOutputs(
                MaterialsUEVplus.ExcitedDTPC.getFluid((recipeModifier * outputModifier).toLong()),
                NyxMaterials.AstralResidue.getLiquid(catalystACA / 4),
        ...
        altBuilder(tr) {
            itemInputs(
                ...
                NyxMaterials.AstralResidue.getLiquid(catalystACA),
    ...
    private fun loadMisc() {
        ...
        // UV
        builder()
            .itemInputs(GTUtility.getIntegratedCircuit(10), NyxItemList.AstriumInfinityGem.get(4))
            .fluidInputs(
        ...
        // UHV
        builder()
            .itemInputs(GTUtility.getIntegratedCircuit(10), NyxItemList.AstriumInfinityGem.get(8))
            .fluidInputs(
                ...
                NyxMaterials.AstralResidue.getLiquid(8 * BUCKETS),
            ).noOptimize()
            .eut(RECIPE_UXV)
            .durSec(8)
            .addTo(tr)
        ...
        // UEV
        builder()
            .itemInputs(GTUtility.getIntegratedCircuit(10), NyxItemList.AstriumInfinityGem.get(16))
            .fluidInputs(
        ...
        // UIV
        builder()
            .itemInputs(GTUtility.getIntegratedCircuit(10), NyxItemList.AstriumInfinityGem.get(32))
            .fluidInputs(
                ...
                NyxMaterials.AstralResidue.getLiquid(32 * BUCKETS),
            ).noOptimize()
            .eut(RECIPE_UXV)
            .durSec(32)
            .addTo(tr)
        ...
        // UMV
        builder()
            .itemInputs(GTUtility.getIntegratedCircuit(10), NyxItemList.AstriumInfinityGem.get(64))
            .fluidInputs(
                ...
                NyxMaterials.AstralResidue.getLiquid(64 * BUCKETS),
            ).noOptimize()
            .eut(RECIPE_UXV)
            .durSec(64)
            .addTo(tr)
        ...
        builder()
            ...
            ).itemOutputs(NyxMaterials.AstriumMagic.getDust(16))
            .fluidInputs(
                NyxMaterials.AstralCatalystBaseExcited.getLiquid(48 * BUCKETS),
                ...
                NyxMaterials.SuperconductorFlux.getLiquid(72 * INGOTS),
                NyxMaterials.AstralResidue.getLiquid(24 * BUCKETS),
            ).specialValue(HeatingCoilLevel.UEV.heat.toInt())
            .noOptimize()
            .eut(RECIPE_UIV)
            .durSec(20)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.AstriumMagic.getDust(64),
                NyxMaterials.AstriumInfinity.getDust(64),
                NyxMaterials.Astrium.getDust(64),
                NyxMaterials.AstriumMagic.getDust(64),
                NyxMaterials.AstriumInfinity.getDust(64),
            ...
            .fluidOutputs(
                ...
                NyxMaterials.AstralResidue.getLiquid(10 * BUCKETS),
        ...
        builder()
            .itemInputs(
                ...
                GTUtility.copyAmountUnsafe(
                    256,
                    GTModHandler.getModItem(Mods.GTPlusPlus.ID, "MU-metaitem.01", 1, 32105),
                ),
            ).fluidInputs(
