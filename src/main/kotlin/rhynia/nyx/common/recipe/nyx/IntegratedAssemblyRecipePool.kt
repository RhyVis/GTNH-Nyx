...
import gregtech.api.enums.Mods.GalaxySpace
...
import gregtech.api.enums.Mods.TinkersGregworks
...
class IntegratedAssemblyRecipePool : RecipePool() {
    private val ia = NyxRecipeMaps.integratedAssemblyRecipes
    ...
    private fun loadMain() {
        ...
        requireMods(AdvancedSolarPanel) {
            builder()
                ...
                ).itemOutputs(AdvancedSolarPanel.getItem("asp_crafting_items", 64, 5))
                .eut(RECIPE_EV)
                .durSec(20)
                .addTo(ia)
        }
        ...
        requireMods(AvaritiaAddons) {
            builder()
                ...
                ).itemOutputs(AvaritiaAddons.getItem("InfinityChest", 1, 0))
                .eut(RECIPE_UHV)
                .durSec(4)
                .addTo(ia)
        }
        ...
        requireMods(TinkersGregworks, Avaritia) {
            builder()
                .itemInputs(
                    ...
                    Avaritia.getItem("Resource", 8, 1),
                    TinkerConstruct.getItem("heavyPlate", 10, 500),
                    TGregUtils.newItemStack(Materials.BlackPlutonium, PartTypes.LargePlate, 8),
                    TinkerConstruct.getItem("heavyPlate", 6, 315),
                ).fluidInputs(
                    Materials.CosmicNeutronium.getIngotMolten(72),
                    Materials.Neutronium.getIngotMolten(4),
                ).itemOutputs(Avaritia.getItem("Neutronium_Compressor", 1, 0))
                .eut(RECIPE_UV)
                .durSec(4)
                .addTo(ia)
        }
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(200),
            ).itemOutputs(IndustrialCraft2.getItem("blockMachine2", 1, 0))
            .eut(RECIPE_EV)
            .durSec(4)
            .addTo(ia)
        // Gravitation Engine
        requireMods(GraviSuite) {
            builder()
                ...
                .itemOutputs(GraviSuite.getItem("itemSimpleItem", 64, 3))
                .eut(RECIPE_IV)
                .durSec(30)
                .addTo(ia)
        }
        // PreTesseract v1
        builder()
            .itemInputs(NyxItemList.AstriumInfinityGem.get(1), BundleChip.ZPM.getItemStack(1))
            .fluidInputs(
            ...
            ).itemOutputs(NyxItemList.PreTesseract.get(64))
            .eut(RECIPE_UEV)
            .durSec(25)
            .addTo(ia)
        // PreTesseract v2
        builder()
            .itemInputs(
                ...
                GTPlusPlus.getItem("MU-metaitem.01", 16, 32105),
            ).fluidInputs(MaterialsUEVplus.TranscendentMetal.getIngotMolten(256))
            .itemOutputs(NyxItemList.PreTesseract.get(1).copyAmountUnsafe(256))
            .eut(RECIPE_UMV)
            .durSec(25)
            .addTo(ia)
        ...
        builder()
            ...
            ).itemOutputs(NyxItemList.LensAstriumMagic.get(1))
            .eut(RECIPE_UEV)
            .durSec(120)
            .addTo(ia)
        // Astrium INF
        builder()
            .itemInputs(
                ...
                NyxMaterials.Astrium.getIngotMolten(128),
                Materials.Glass.getIngotMolten(1024),
                Materials.CosmicNeutronium.getIngotMolten(512),
            ).itemOutputs(NyxItemList.LensAstriumInfinity.get(1))
            .eut(RECIPE_UEV)
            .durSec(120)
            .addTo(ia)
        // Or
        builder()
            .itemInputs(
                ...
                NyxMaterials.Originium.getDust(64),
            ).fluidInputs(
                NyxMaterials.Originium.getIngotMolten(128),
                Materials.Glass.getIngotMolten(64),
                GGMaterial.orundum.getIngotMolten(64),
            ).itemOutputs(NyxItemList.LensOriginium.get(1))
            .eut(RECIPE_UHV)
            .durSec(120)
            .addTo(ia)
        // Pr
        builder()
            .itemInputs(
                GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.ReinforcedGlassLense", 64, 0),
                NyxMaterials.Primoium.getDust(64),
            ).fluidInputs(
                NyxMaterials.Primoium.getIngotMolten(128),
                Materials.Glass.getIngotMolten(64),
                Materials.DraconiumAwakened.getIngotMolten(64),
            ).itemOutputs(NyxItemList.LensPrimoium.get(1))
            .eut(RECIPE_UHV)
            .durSec(120)
            .addTo(ia)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(6400),
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(16 * 800),
            ).itemOutputs(ItemList.Energy_LapotronicOrb2.get(16))
            .eut(RECIPE_ZPM)
            .durSec(12 * 50)
            .addTo(ia)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(16 * 1000),
            ).itemOutputs(ItemList.Energy_Module.get(16))
            .eut(RECIPE_UV)
            .durSec(12 * 50)
            .addTo(ia)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(16 * 2000),
            ).itemOutputs(ItemList.Energy_Cluster.get(16))
            .eut(RECIPE_UHV)
            .durSec(12 * 50)
            .addTo(ia)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.SuperconductorFlux.getLiquid(16 * 4 * INGOTS),
                FluidUtil.getFluidStack("ic2coolant", 16 * 16000),
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.LapotronEnhancedFluid.getLiquid(16 * 5000),
            ).itemOutputs(ItemList.ZPM2.get(16))
            .eut(RECIPE_UEV)
            .durSec(12 * 50)
            .addTo(ia)
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.SuperconductorFlux.getLiquid(16 * 16 * INGOTS),
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.SuperconductorFlux.getLiquid(16 * 64 * INGOTS),
        ...
        builder()
            .itemInputs(
                ...
                GTUtility.copyAmountUnsafe(
                    16 * 64,
                    GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.RawPicoWafer", 1),
                ),
                BartPart.OpticalDiode.getItemStack(64),
                ...
                Materials.Quantium.getMolten(16 * 18432),
                NyxMaterials.SuperconductorFlux.getLiquid(16 * 128 * INGOTS),
        ...
        builder()
            .itemInputs(
                ...
                NyxMaterials.SuperconductorFlux.getLiquid(16 * 256 * INGOTS),
        ...
        // region 戴森球
        requireMods(GTNHIntergalactic, GalaxySpace) {
            fun gsPart(
                amount: Int,
                meta: Int,
            ) = GalaxySpace.getItem("item.DysonSwarmParts", amount, meta)
            // 耐高温网 1024
            builder()
                .itemInputs(
                    ItemUtil.setStackSize(
                        GTOreDictUnificator.get(OrePrefixes.itemCasing, Materials.Carbon, 1),
                        128,
                    ),
                    ItemUtil.setStackSize(
                        GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Neutronium, 1),
                        512,
                    ),
                    ItemUtil.setStackSize(
                        GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.TungstenCarbide, 1),
                        512,
                    ),
                    ItemUtil.setStackSize(
                        GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Tantalum, 1),
                        512,
                    ),
                ).fluidInputs(
                    SolderMaterial.IndaAlloy.getFluidStack(128 * INGOTS),
                    MaterialsAlloy.SILICON_CARBIDE.getFluidStack(48 * INGOTS),
                ).itemOutputs(gsPart(1, 3).ofSize(1024))
                .eut(RECIPE_LuV)
                .durSec(200)
                .addTo(ia)
            // 戴森球模块 512 8x
            builder()
                ...
                .itemOutputs(gsPart(1, 0).ofSize(8 * 64))
                .eut(RECIPE_UEV)
                .durSec(5)
                .addTo(ia)
        }
        ...
        builder()
            .itemInputs(
                ...
                GTUtility.copyAmountUnsafe(
                    128,
                    GTModHandler.getModItem("gregtech", "gt.blockmachines", 1, 15470),
                ),
            ).fluidInputs(
        ...
        builder()
            .itemInputs(
                *Array(8) { GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Trinium, 64) },
                NyxItemList.DenseMicaInsulatorFoil.get(64),
            ).fluidInputs(NyxMaterials.SuperconductorFlux.getLiquid(64 * INGOTS))
        ...
        builder()
            .itemInputs(
                BundleChip.UHV.getItemStack(1),
                NyxItemList.DenseMicaInsulatorFoil.get(64),
                NyxItemList.DenseMicaInsulatorFoil.get(32),
            ).fluidInputs(
        ...
        builder()
            .itemInputs(
                ...
                GTModHandler.getModItem(
                    AppliedEnergistics2.ID,
                    "item.ItemExtremeStorageCell.Quantum",
                    1,
                ),
            ).eut(RECIPE_UV)
            .durSec(4)
        ...
        builder()
            .itemInputs(
                ...
                NyxItemList.CrystalMatrix.get(2),
            ).fluidInputs(
    ...
    private fun loadTstRecipe() {
        ...
        builder()
            .itemInputs(
                ...
                NyxItemList.PreTesseract.get(8),
                NyxItemList.AstriumInfinityGem.get(1),
            ).fluidInputs(
                NyxMaterials.AstriumMagic.getMolten(8 * INGOTS),
                MaterialsUEVplus.SpaceTime.getIngotMolten(4),
            ).itemOutputs(
                // GTCMItemList.ParticleTrapTimeSpaceShield.get(64)
                NyxMods.TwistSpaceTechnology.getItem("MetaItem01", 64, 4),
            ).noOptimize()
            .eut(RECIPE_UIV)
            .durSec(60)
            .addTo(ia)
