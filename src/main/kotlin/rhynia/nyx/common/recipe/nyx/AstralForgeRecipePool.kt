...
import rhynia.nyx.api.enums.NyxValues.RecipeValues.RECIPE_HV
...
class AstralForgeRecipePool : RecipePool() {
  private val af = NyxRecipeMaps.astralForgeRecipes
  ...
  override fun loadRecipes() {
    ...
    builder()
        .itemInputs(
            ...
            NyxMaterials.Astrium.getDust(16),
    ...
    builder()
        ...
        .fluidInputs(Materials.Water.getBucketFluid(1), NyxMaterials.Astrium.getMolten(16))
    ...
    builder()
        ...
        .fluidInputs(Materials.Lava.getBucketFluid(1), NyxMaterials.Astrium.getMolten(16))
    ...
    builder()
        ...
        .fluidInputs(NyxMaterials.Astrium.getMolten(16))
    ...
    builder()
        ...
        .fluidInputs(NyxMaterials.Astrium.getMolten(1000))
    ...
    builder()
        .itemInputs(
            ...
            chromaticLens,
            NyxItemList.LensPrimoium.get(0),
        ...
        .itemOutputs(
            ...
            NyxMaterials.AstriumMagic.getDust(32),
            NyxMaterials.AstriumInfinity.getDust(32),
        )
        ...
        .forEach { s ->
          val inputArray =
              arrayOfNulls<ItemStack>(16).apply {
                ...
                this[1] = NyxItemList.LensAstriumInfinity.get(0)
                fill(s.getDust(64), 2)
              }
          builder()
    ...
    builder()
        ...
        .itemOutputs(
            *Array(8) { phDust },
            *Array(4) { NyxMaterials.Astrium.getDust(64) },
        )
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NyxItemList.LensAstriumInfinity.get(0), *Array(14) { na2So4 })
        .itemOutputs(
            *Array(10) { naDust },
            Materials.Sulfur.getDust(64),
            Materials.Sulfur.getDust(64),
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NyxItemList.LensAstriumInfinity.get(0), *Array(4) { smMix })
        .itemOutputs(
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NyxItemList.LensAstriumInfinity.get(0), *Array(4) { ceMix })
        .itemOutputs(
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NyxItemList.LensAstriumInfinity.get(0), *Array(8) { irRe })
        .itemOutputs(
            *Array(8) { irDust },
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(8), NyxItemList.LensAstriumInfinity.get(0), *Array(8) { osRe })
        .itemOutputs(
            Materials.Iridium.getDust(64),
            Materials.Iridium.getDust(64),
            Materials.Iridium.getDust(64),
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(4),
            NyxItemList.LensAstriumInfinity.get(0),
            NyxMaterials.AstriumInfinity.getDust(12),
    ...
    builder()
        .itemInputs(
            getIntegratedCircuit(4),
            NyxItemList.LensAstriumInfinity.get(0),
            NyxMaterials.Astrium.getDust(60),
    ...
    builder()
        ...
        .itemOutputs(NyxMaterials.Originium.getDust(64), NyxMaterials.Originium.getDust(48))
        .eut(RECIPE_UHV)
        .durMin(2)
        .addTo(af)
    ...
    arrayOf(
        ...
        .forEachIndexed { index, material ->
          ...
          builder()
              .itemInputs(getIntegratedCircuit(1), NyxItemList.LensPrimoium.get(0))
              .itemOutputs(*Array(16) { NyxMaterials.Astrium.getDust(modifier) })
              .fluidInputs(material.getBucketFluid(16))
              .fluidOutputs(
                  NyxMaterials.Astrium.getMolten(12 * modifier * INGOTS),
                  NyxMaterials.AstriumInfinity.getMolten(4 * modifier * INGOTS),
              )
              .eut(RECIPE_UV)
              .durSec(16)
              .addTo(af)
