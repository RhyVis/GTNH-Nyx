...
object CelValues {
  ...
  object TextureSets {
    ...
    val Logo32: UITexture = UITexture.fullImage("constellation", "gui/picture/va_logo_32_t")
  }

  object CommonStrings {
    val CelMagical = "${AQUA}Constellation${RED}Creation${GRAY} - ${GREEN}Magical Reveal"
    val CelNuclear = "${AQUA}Constellation${RED}Creation${GRAY} - ${GREEN}Thermonuclear Reaction"
    val CelGigaFac = "${AQUA}Constellation${RED}Creation${GRAY} - ${GREEN}Giga Factory"
    val AddByConstellation = "由 ${GREEN}Constellation${GRAY} 添加"
