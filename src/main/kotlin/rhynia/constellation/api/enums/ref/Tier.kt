...
import rhynia.constellation.api.enums.CelValues.RecipeValues.INGOT
...
enum class Tier(private val material: Materials) {
  ...
  private val fallbackStack: ItemStack
    get() = CelItemList.TestItem01.get(1)
  ...
  fun getCoil(amount: Int): ItemStack =
      when (this) {
        ...
        UXV,
        MAX -> fail("$this coil")
        else -> ItemList.valueOf("${this}_Coil").get(amount.toLong(), CelItemList.TestItem01.get(1))
      }
      ...
      when (this) {
        MAX -> fail("MAX dynamo hatch")
            ...
            ItemList.valueOf("Hatch_Dynamo_$this")
                .get(amount.toLong(), CelItemList.TestItem01.get(1))
      }
  ...
  fun getLaserWireless(tier: @Range(from = 1, to = 7) Int, amount: Int): ItemStack =
      when (this) {
        ...
        UXV ->
            ...
            CelWirelessHatchList.valueOf("ExtLaser${this}$tier")
                .get(amount.toLong(), CelItemList.TestItem01.get(1))
      }
}
