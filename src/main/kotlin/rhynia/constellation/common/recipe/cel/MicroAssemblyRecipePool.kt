...
class MicroAssemblyRecipePool : RecipePool() {
  private val ma = CelRecipeMaps.microAssemblyRecipes
  ...
  private fun loadMain() {
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(4 * INGOTS * multiple.toInt()))
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(16 * INGOTS * multiple.toInt()))
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(6 * INGOTS),
    ...
    for (i in 1 until 10) {
      builder()
          ...
          .itemOutputs(CelItemList.valueOf("EOHCoreT$i").get(1))
          .eut(RECIPE_UXV)
          .durSec(16 * i)
          .addTo(ma)
    }
  ...
  private fun loadTstRecipe() {
    ...
    builder()
        ...
        .itemOutputs(
            ...
            CelMods.TwistSpaceTechnology.getItem("MetaItem01", 64, 2))
        .noOptimize()
        .eut(RECIPE_UMV)
        .durSec(512)
        .addTo(ma)
  ...
  private fun loadMachineAssembly() {
    ...
    builder()
        ...
        .itemOutputs(CelItemList.AssemblyDTPF.get(1))
        .noOptimize()
        .eut(RECIPE_UMV)
        .durSec(16)
        .addTo(ma)
