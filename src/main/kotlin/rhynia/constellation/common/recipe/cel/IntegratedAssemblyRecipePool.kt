...
import rhynia.constellation.api.enums.CelValues.RecipeValues.SECOND
import rhynia.constellation.api.enums.ref.BartPart
import rhynia.constellation.api.enums.ref.BasicRef
import rhynia.constellation.api.enums.ref.BundleChip
...
class IntegratedAssemblyRecipePool : RecipePool() {
  private val ia = CelRecipeMaps.integratedAssemblyRecipes

  override fun loadRecipes() {
    loadMain()

    if (Config.loadTstRecipe && CelMods.TwistSpaceTechnology.isModLoaded) loadTstRecipe()
  ...
  private fun loadMain() {
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(200))
    ...
    // PreTesseract v1
    builder()
        .itemInputs(CelItemList.AstriumInfinityGem.get(1), BundleChip.ZPM.getItemStack(1))
        .fluidInputs(
        ...
        .itemOutputs(CelItemList.PreTesseract.get(64))
        .eut(RECIPE_UEV)
        .durSec(25)
        .addTo(ia)
    // PreTesseract v2
    builder()
        ...
        .itemOutputs(CelItemList.PreTesseract.get(1).copyAmountUnsafe(256))
        .eut(RECIPE_UMV)
        .durSec(25)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            CelMaterials.Astrium.getIngotMolten(32),
            Materials.Glass.getIngotMolten(128),
            Materials.Neutronium.getIngotMolten(64))
        .itemOutputs(CelItemList.LensAstriumMagic.get(1))
        .eut(RECIPE_UEV)
        .durSec(120)
        .addTo(ia)
    // Astrium INF
    builder()
        .itemInputs(
            ...
            CelItemList.AstriumInfinityGem.get(32),
        )
        .fluidInputs(
            CelMaterials.Astrium.getIngotMolten(128),
            Materials.Glass.getIngotMolten(1024),
            Materials.CosmicNeutronium.getIngotMolten(512))
        .itemOutputs(CelItemList.LensAstriumInfinity.get(1))
        .eut(RECIPE_UEV)
        .durSec(120)
        .addTo(ia)
    // Or
    builder()
        .itemInputs(
            ...
            CelMaterials.Originium.getDust(64),
        )
        .fluidInputs(
            CelMaterials.Originium.getIngotMolten(128),
            Materials.Glass.getIngotMolten(64),
            GGMaterial.orundum.getIngotMolten(64))
        .itemOutputs(CelItemList.LensOriginium.get(1))
        .eut(RECIPE_UHV)
        .durSec(120)
        .addTo(ia)
    // Pr
    builder()
        .itemInputs(
            GTModHandler.getModItem(NewHorizonsCoreMod.ID, "item.ReinforcedGlassLense", 64, 0),
            CelMaterials.Primoium.getDust(64),
        )
        .fluidInputs(
            CelMaterials.Primoium.getIngotMolten(128),
            Materials.Glass.getIngotMolten(64),
            Materials.DraconiumAwakened.getIngotMolten(64))
        .itemOutputs(CelItemList.LensPrimoium.get(1))
        .eut(RECIPE_UHV)
        .durSec(120)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(6400))
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(16 * 800))
        .itemOutputs(ItemList.Energy_LapotronicOrb2.get(16))
        .eut(RECIPE_ZPM)
        .durSec(12 * 50)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(16 * 1000))
        .itemOutputs(ItemList.Energy_Module.get(16))
        .eut(RECIPE_UV)
        .durSec(12 * 50)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(16 * 2000))
        .itemOutputs(ItemList.Energy_Cluster.get(16))
        .eut(RECIPE_UHV)
        .durSec(12 * 50)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(16 * 4 * INGOTS),
            FluidUtil.getFluidStack("ic2coolant", 16 * 16000))
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.LapotronEnhancedFluid.getLiquid(16 * 5000))
        .itemOutputs(ItemList.ZPM2.get(16))
        .eut(RECIPE_UEV)
        .durSec(12 * 50)
        .addTo(ia)
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(16 * 16 * INGOTS),
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(16 * 64 * INGOTS),
    ...
    builder()
        ...
        .fluidInputs(
            ...
            Materials.Quantium.getMolten(16 * 18432),
            CelMaterials.SuperconductorFlux.getLiquid(16 * 128 * INGOTS),
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.SuperconductorFlux.getLiquid(16 * 256 * INGOTS),
    ...
    builder()
        .itemInputs(
            *Array(8) { GTOreDictUnificator.get(OrePrefixes.wireFine, Materials.Trinium, 64) },
            CelItemList.DenseMicaInsulatorFoil.get(64),
        )
        .fluidInputs(CelMaterials.SuperconductorFlux.getLiquid(64 * INGOTS))
    ...
    builder()
        .itemInputs(
            BundleChip.UHV.getItemStack(1),
            CelItemList.DenseMicaInsulatorFoil.get(64),
            CelItemList.DenseMicaInsulatorFoil.get(32))
        .fluidInputs(
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.CrystalMatrix.get(2))
        .fluidInputs(
  ...
  private fun loadTstRecipe() {
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.PreTesseract.get(8),
            CelItemList.AstriumInfinityGem.get(1))
        .fluidInputs(
            CelMaterials.AstriumMagic.getMolten(8 * INGOTS),
            MaterialsUEVplus.SpaceTime.getIngotMolten(4))
        .itemOutputs(
            // GTCMItemList.ParticleTrapTimeSpaceShield.get(64)
            CelMods.TwistSpaceTechnology.getItem("MetaItem01", 64, 4))
        .noOptimize()
        .eut(RECIPE_UIV)
        .durSec(60)
        .addTo(ia)
