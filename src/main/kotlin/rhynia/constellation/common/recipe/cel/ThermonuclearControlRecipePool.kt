...
class ThermonuclearControlRecipePool : RecipePool() {
  ...
  override fun loadRecipes() {
    ...
    // 等离子 He
    builder()
        .itemInputs(GTUtility.getIntegratedCircuit(12), CelItemList.LensAstriumInfinity.get(0))
    ...
    builder()
        ...
        .fluidInputs(CelMaterials.AstralCatalystBaseExcited.getLiquid(BUCKETS))
        .fluidOutputs(
            CelMaterials.LapotronEnhancedFluid.getLiquid(8 * BUCKETS),
            CelMaterials.AstralResidue.getLiquid(500))
        .eut(RECIPE_UHV)
        .durSec(115)
        .addTo(tc)
    ...
    builder()
        ...
        .fluidInputs(
            CelMaterials.AstralCatalystBaseExcited.getLiquid(32 * BUCKETS),
            CelMaterials.SuperconductorFluxRaw.getMolten(72 * INGOTS))
        .fluidOutputs(
            CelMaterials.SuperconductorFlux.getLiquid(64 * INGOTS),
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.LensAstriumInfinity.get(0),
            esCata,
            CelItemList.AstriumInfinityGem.get(64))
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.LensAstriumInfinity.get(0),
            esCata,
            CelItemList.AstriumInfinityGem.get(8))
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.Astrium.getMolten(12 * BUCKETS))
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.LensAstriumInfinity.get(0),
            esCata,
            CelItemList.PreTesseract.get(64))
        .fluidInputs(
    ...
    builder()
        ...
        .fluidInputs(
            ...
            CelMaterials.AstralCatalystReforged.getLiquid(250))
        .fluidOutputs(
            GGMaterial.shirabon.getMolten(16 * INGOTS), CelMaterials.AstralResidue.getLiquid(500))
        .eut(RECIPE_UMV)
        .durSec(25)
        .addTo(tc)
    ...
    builder()
        .itemInputs(
            ...
            CelItemList.LensAstriumInfinity.get(0),
            esCata,
            GTUtility.copyAmountUnsafe(96, CelItemList.AstriumInfinityGem.get(1)))
        .fluidInputs(
        ...
        .fluidOutputs(
            ...
            CelMaterials.AstralResidue.getLiquid(5000))
        .eut(RECIPE_UIV)
        .durSec(80)
        .addTo(tc)
    // endregion
