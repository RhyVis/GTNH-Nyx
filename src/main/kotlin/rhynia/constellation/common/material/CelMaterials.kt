package rhynia.constellation.common.material
...
object CelMaterials : Loader {
  override fun load() {
    Log.info("Adding materials by Constellation...")
  }

  val Null =
      CelMaterial(0, "null", "空", shortArrayOf(250, 250, 250, 255)).also {
  ...
  val Astrium =
      CelMaterial(1, "Astrium", "星源", shortArrayOf(30, 144, 252, 255)).also {
  ...
  val AstriumInfinity =
      CelMaterial(2, "AstriumInfinity", "星极", shortArrayOf(0, 191, 255, 255)).also {
  ...
  val AstriumMagic =
      CelMaterial(3, "AstriumMagic", "星辉", shortArrayOf(0, 32, 178, 170)).also {
  ...
  val Primoium =
      CelMaterial(8, "Primoium", "原石", shortArrayOf(0x87, 0xce, 0xeb)).also {
  ...
  val Originium =
      CelMaterial(9, "Originium", "源石", shortArrayOf(0xda, 0xa5, 0x20)).also {
        it.textureSet = TextureSet.SET_SHINY
        it.protons = 165
        it.mass = 445
  ...
  val AstralCatalystBase =
      CelMaterial(201, "AstralCatalystBase", "星体催化剂", shortArrayOf(0x48, 0x3d, 0x8b)).also {
  ...
  val AstralCatalystBaseExcited =
      CelMaterial(202, "AstralCatalystBaseExcited", "激发星体催化剂", shortArrayOf(0x6a, 0x5a, 0xcd))
          .also {
            it.textureSet = TextureSet.SET_FLUID
            it.addElementalTooltip("(?Aμⁿ2If3?)*")
  ...
  val AstralCatalystReforged =
      CelMaterial(203, "AstralCatalystReforged", "重铸星体催化剂", shortArrayOf(0x41, 0x84, 0xe1)).also {
        it.textureSet = TextureSet.SET_FLUID
  ...
  val AstralResidue =
      CelMaterial(204, "AstralResidue", "矮星物质", shortArrayOf(0x19, 0x19, 0x70)).also {
        it.textureSet = TextureSet.SET_FLUID
        it.addElementalTooltip("Aμ°")
  ...
  val LapotronEnhancedFluid =
      CelMaterial(401, "LapotronEnhancedFluid", "兰波顿聚能流体", shortArrayOf(0x64, 0x95, 0xed)).also {
        it.textureSet = TextureSet.SET_FLUID
  ...
  val SuperconductorFluxRaw =
      CelMaterial(402, "SuperconductorFluxRaw", "粗制超导流体", shortArrayOf(0x69, 0x69, 0x69)).also {
  ...
  val SuperconductorFlux =
      CelMaterial(403, "SuperconductorFlux", "超导流体", shortArrayOf(0xC0, 0xC0, 0xC0)).also {
        it.textureSet = TextureSet.SET_FLUID
