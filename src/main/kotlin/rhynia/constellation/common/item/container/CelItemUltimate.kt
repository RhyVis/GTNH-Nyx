package rhynia.constellation.common.item.container
...
import rhynia.constellation.client.CelTab.TabItem

class CelItemUltimate() : Item() {
  init {
    setCreativeTab(TabItem)
    setMaxStackSize(1)
    setUnlocalizedName("ultimate")
    setTextureName("$CEL_MOD_ID:ultimate")
  }
