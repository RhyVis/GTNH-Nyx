...
import rhynia.constellation.api.enums.CelValues.TextureSets.Logo32
...
class CelMTEZeroGenerator : MTETieredMachineBlock, IAddUIWidgets, IAddGregtechLogo {
  ...
  constructor(
      ...
      arrayOf(
          ...
          "使用螺丝刀切换至无线模式",
          "直接注入能量到无线网络!",
          CelValues.CommonStrings.AddByConstellation)) {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): MetaTileEntity {
    return CelMTEZeroGenerator(mName, mTier.toInt(), mDescriptionArray, mTextures)
  }
