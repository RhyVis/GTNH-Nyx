...
class CelMTEEyeOfUltimate : CelMTECubeBase<CelMTEEyeOfUltimate> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return CelMTEEyeOfUltimate(this.mName)
  }
  ...
  private val checkStackB by lazy { CelItemList.AstriumInfinityComplex.get(1) }
  ...
  override val sCoreBlockEl: IStructureElement<CelMTEEyeOfUltimate> by lazy {
    StructureUtility.ofBlocksTiered<CelMTEEyeOfUltimate, Int>(
        ...
        -1,
        { t: CelMTEEyeOfUltimate, meta: Int -> t.pSpacetimeCompressionFieldMetadata = meta },
        { it.pSpacetimeCompressionFieldMetadata })
  }

  override val sCasingHatch: Array<IHatchElement<in CelMTEEyeOfUltimate>>
