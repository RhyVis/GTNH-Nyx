package rhynia.constellation.common.tile.multi.creation
...
import rhynia.constellation.api.util.MathUtil
import rhynia.constellation.api.util.NBTUtil.getFluid
import rhynia.constellation.api.util.NBTUtil.getItem
import rhynia.constellation.api.util.NBTUtil.setFluid
...
class CelMTECreator : CelMTECubeBase<CelMTECreator> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return CelMTECreator(this.mName)
  }
  ...
  private val pItemStackZeroPoint: ItemStack by lazy { CelItemList.TestItem01.get(1) }
  ...
  private val pFluidStackZeroPoint: FluidStack by lazy { CelMaterials.Null.getFluid(1) }
  ...
  override val sCasingHatch: Array<IHatchElement<in CelMTECreator>>
  ...
  protected override fun createTooltip(): MultiblockTooltipBuilder =
      MultiblockTooltipBuilder()
          ...
          .toolTipFinisher(CelValues.CommonStrings.CelMagical)
            ...
            .dynamicTooltip {
              mutableListOf(
                  StatCollector.translateToLocal(
                      "constellation.Creator.pItemProcess.$pItemProcessModeInt"))
            }
