...
class CelMTEAstralForge : CelMTEBase<CelMTEAstralForge> {
  ...
  override fun getRecipeMap(): RecipeMap<*> = CelRecipeMaps.astralForgeRecipes
  ...
  override fun genStructureDefinition(): IStructureDefinition<CelMTEAstralForge> =
      StructureDefinition.builder<CelMTEAstralForge>()
          .addShape(STRUCTURE_PIECE_MAIN, StructureUtility.transpose(structureShape))
          .addElement('A', ofBlock(GregTechAPI.sBlockCasings2, 9))
          .addElement(
              'B',
              HatchElementBuilder.builder<CelMTEAstralForge>()
                  .atLeast(InputBus, OutputBus, InputHatch, OutputHatch)
                  .adder(CelMTEAstralForge::addMachineListCompatible)
                  .dot(1)
                  .casingIndex(183)
