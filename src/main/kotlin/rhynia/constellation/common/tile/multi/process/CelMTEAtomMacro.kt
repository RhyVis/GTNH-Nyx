...
class CelMTEAtomMacro : CelMTEBase<CelMTEAtomMacro> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return CelMTEAtomMacro(this.mName)
  }
  ...
  private var pRecipeMode =
      ModeContainer.of(
          CelRecipeMaps.thermonuclearControlRecipes,
          CelRecipeMaps.transcendentReactorRecipes,
    ...
    if (baseMetaTileEntity.isServerSide) {
      ...
      GTUtility.sendChatToPlayer(
          ...
          StatCollector.translateToLocal(
              "constellation.AtomMacro.pRecipeMode.${pRecipeMode.index}"))
    }
  }
  // endregion
  ...
  override fun genStructureDefinition(): IStructureDefinition<CelMTEAtomMacro> =
      StructureDefinition.builder<CelMTEAtomMacro>()
          ...
          .addElement(
              'G',
              HatchElementBuilder.builder<CelMTEAtomMacro>()
                  .atLeast(InputBus, InputHatch)
                  .adder(CelMTEAtomMacro::addToMachineList)
                  .dot(1)
