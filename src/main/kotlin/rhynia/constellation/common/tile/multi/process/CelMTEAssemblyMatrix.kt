...
class CelMTEAssemblyMatrix : CelMTEBase<CelMTEAssemblyMatrix> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return CelMTEAssemblyMatrix(this.mName)
  }
  ...
  private val pRecipeMode =
      ModeContainer.of(
          CelRecipeMaps.integratedAssemblyRecipes,
          CelRecipeMaps.microAssemblyRecipes,
          CelRecipeMaps.superconductingFormingRecipes)
    ...
    if (baseMetaTileEntity.isServerSide) {
      ...
      GTUtility.sendChatToPlayer(
          ...
          StatCollector.translateToLocal(
              "constellation.AssemblyMatrix.pRecipeMode.${pRecipeMode.index}"))
    }
  }
  // endregion
  ...
  override fun genStructureDefinition(): IStructureDefinition<CelMTEAssemblyMatrix> =
      StructureDefinition.builder<CelMTEAssemblyMatrix>()
          ...
          .addElement(
              'C',
              HatchElementBuilder.builder<CelMTEAssemblyMatrix>()
                  .atLeast(InputBus, InputHatch, Energy.or(ExoticEnergy))
                  .adder(CelMTEAssemblyMatrix::addToMachineList)
                  .dot(1)
  ...
  protected override fun createTooltip(): MultiblockTooltipBuilder =
      MultiblockTooltipBuilder()
          ...
          .addOutputBus(CelValues.CommonStrings.BluePrintInfo, 2)
          .addEnergyHatch(CelValues.CommonStrings.BluePrintInfo, 1)
          .toolTipFinisher(CelValues.CommonStrings.CelGigaFac)
