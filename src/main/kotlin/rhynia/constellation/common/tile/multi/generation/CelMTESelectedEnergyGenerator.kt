package rhynia.constellation.common.tile.multi.generation
...
class CelMTESelectedEnergyGenerator : CelMTECubeBase<CelMTESelectedEnergyGenerator> {
  ...
  override fun newMetaEntity(aTileEntity: IGregTechTileEntity?): IMetaTileEntity {
    return CelMTESelectedEnergyGenerator(this.mName)
  }
