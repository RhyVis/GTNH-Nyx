...
abstract class CelMTECubeBase<T : CelMTEBase<T>> : CelMTEBase<T> {
  ...
  protected open val sCasingIndex: Int
    ...
    get() = GTUtility.getCasingTextureIndex(sCasingBlock.first, sCasingBlock.second)
  ...
  protected open val sCasingHatch: Array<IHatchElement<in T>>
    get() =
        arrayOf(
            ...
            gregtech.api.enums.HatchElement.Energy.or(gregtech.api.enums.HatchElement.ExoticEnergy),
            gregtech.api.enums.HatchElement.Dynamo.or(ExoticDynamo))
