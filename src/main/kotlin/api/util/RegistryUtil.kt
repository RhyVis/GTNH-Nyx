...
object RegistryUtil {
    fun registerMetaItem(
        ...
        meta: Int,
    ): ItemStack = item.registerVariant(meta)
    ...
    fun registerMetaItem(
        ...
        meta: Int,
        tooltip: String,
    ): ItemStack = registerMetaItem(item, meta, arrayOf(tooltip))

    fun registerMetaBlock(
    ...
    fun registerMetaBlock(
        ...
        meta: Int,
        tooltip: String,
    ): ItemStack = registerMetaBlock(block, meta, arrayOf(tooltip))
}
