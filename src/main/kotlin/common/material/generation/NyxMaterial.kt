...
class NyxMaterial(
     ...
     */
    fun isTypeValid(prefix: OrePrefixes) = prefix in allowedOrePrefixes && prefix !in disabledOrePrefixes
    ...
    fun getFluidStack(
        state: FluidState,
        amount: Int = 1000,
    ) = FluidStack(getFluid(state), amount)
